...
<head>
    ...
    <title>Edit {{$user->name}}- Carwash</title>
...
<span></span>
                ...
                <a href="{{url('/')}}" class="navbar-brand logo">
                    <img src="{{url('assets/img/logo.jpg')}}" class="img-fluid" alt="Logo">
                </a>
            </div>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div>
                                        <div class="form-group">
                                            <label>Name</label>
                                            <input type="text" class="form-control" name="name" placeholder="Input Name" value="{{$user->name}}" required>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="form-group">
                                            <label>Phone</label>
                                            <input type="email" class="form-control" name="email" placeholder="Input Email" value="{{$user->email}}" required>
                                        </div>
                                    </div>
                                        @if($user->role==1)
                                            <div class="form-group">
                                            ...
                                            <div class="col-8">
                                                @if($user->cars==4)
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input" name="cars" value="4" id="customCheck1" checked>
                                                ...
                                                @endif
                                                    ...
                                                    @if($user->washer==3)
                                                    <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" name="washers" value="3" id="customCheck2" checked>
                                                    ...
                                                    @if($user->payments==2)
                                                    <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" name="payments" value="2" id="customCheck3" checked>
                                                    ...
                                                    @if($user->charges==1)
                                                    <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" name="charges" value="1" id="customCheck4" checked>
                                                    ...
                                                    @if($user->users==5)
                                                    <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" name="users" value="5" id="customCheck5" checked>
                                                    <label class="custom-control-label" for="customCheck5">Users</label>
                                                </div>
                                                    @else
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" name="users" value="5" id="customCheck5">
                                                            <label class="custom-control-label" for="customCheck5">Users</label>
                                                        </div>
                                                    @endif
                                            </div>
